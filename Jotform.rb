...
#Click on Today's date (had to double click because i noticed it is a little buggy)
 browser.td(class: 'selected today').wait_until(timeout: 100, &:present?).double_click
...
#Assert that form has been submitted
browser.h1(class: 'jfThankYou-header form-header').wait_until_present(10)
